...
namespace MRQ.CryptoBot.Integration.Nethereum
{
    public class PancakeSwapAdapter : IBlockChainOperationAdapter
    {
        ...
        public PancakeSwapAdapter()
        {
            ...
            ConfigurationDto.ContractRouterForSwap = "0x10ED43C718714eb63d5aA57B78B54704E256024E";
            ConfigurationDto.TokenDefaultContract = "0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c";
            ConfigurationDto.SlippageTolerance = 0.90M; //10%
            ConfigurationDto.DefaultGasPrice = 5000000000;
            ConfigurationDto.DefaultGas = 290000;
        ...
        public async Task<Returned> SwapTokensAsync(WalletDto walletDto, TokenDto tokenOrigin, TokenDto tokenDestination)
        {
            ...
            try
            {
                ...
                var contractAddress = ConfigurationDto.ContractRouterForSwap;
                ...
                var swapDTO = new SwapExactTokensForTokens()
                {
                    ...
                    GasPrice = ConfigurationDto.DefaultGasPrice,
                    Gas = ConfigurationDto.DefaultGas
                };
