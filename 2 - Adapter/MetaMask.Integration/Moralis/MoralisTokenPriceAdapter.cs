...
namespace MRQ.CryptoBot.Integration.Moralis
{
    public class MoralisTokenPriceAdapter : ITokenPriceAdapter
    {
        ...
        public async Task<PriceOfTokenDto> GetTokenFromMoralis(string token)
        {
            ...
            PriceOfTokenDto balanceDto = JsonSerializer.Deserialize<PriceOfTokenDto>(await response.Content.ReadAsStringAsync(), _jsonSerializerOptions);
